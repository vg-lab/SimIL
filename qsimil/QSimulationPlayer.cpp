...
namespace qsimil
{
	...
	void QSimulationPlayer::_Repeat( bool )
	{
		if( _simPlayer )
		{
			...
			// TODO: this->_icp->cpClickRestart( repeat );
		}
	}
	...
	void QSimulationPlayer::_PlayAt( bool notify )
	{
		if( _simPlayer )
		{
            //std::cout << "POS SLIDER:" << _simSlider->sliderPosition( ) << std::endl;
	...
	void QSimulationPlayer::applyPlaybackOpertion( unsigned int playbackOp )
	{
  	...
  	void QSimulationPlayer::_zeqEventRepeat( bool repeat )
	{
